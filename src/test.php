...
<body class="bg-gray-500">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          <div class="flex items-center ms-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-red-500 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
  ...
  <aside id="logo-sidebar" class="fixed top-0 right-0 z-40 w-72 h-screen pt-20 transition-transform -translate-x-full bg-white border-l border-gray-200 sm:translate-x-0 dark:bg-gray-500 dark:border-gray-700 hidden sm:block" aria-label="Sidebar">
    <div class="h-full pt-2 pb-7 gap-5 pl-1 pr-8 overflow-y-auto bg-white dark:bg-gray-500 grid grid-rows-2">

      <a href="#" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 row-span-1 overflow-y-auto">

        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Announcements</h5>
        <p class="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae, dolores. Recusandae consequatur explicabo quibusdam dolore hic accusantium fuga tempore rerum.</p>
      </a>
      <a href="#" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 row-span-1 overflow-y-auto">
  ...
  <div class="p-4 sm:ml-64 sm:mr-72">
    <div class="pt-4 pl-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <h1 class="font-bold text-4xl pb-6">Software Engineering</h1>
