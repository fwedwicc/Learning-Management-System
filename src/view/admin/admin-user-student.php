  ...
  <div class="p-4 sm:ml-64 h-screen flex flex-col">
    <div class="pt-4 px-5 mt-14 flex-grow flex flex-col">
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Student account registered and enrolled successfully!</h3>
      ...
      <div id="tab-content">
              ...
              <tbody>
                <tr class="bg-white border-b border-indigo-100">
                  ...
                  <td class="flex items-center px-6 py-4">
                    ...
                    <button data-modal-target="unenroll-modal" data-modal-toggle="unenroll-modal" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Unenroll</button>
                  </td>
                </tr>
                <tr class="bg-white border-b border-indigo-100">
                  <th scope="row" class="px-6 py-4 font-medium text-deep-koamaru whitespace-nowrap">
        ...
        <div id="unenroll-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                <svg class="mx-auto mb-4 text-corn-flower-blue w-12 h-12" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center px-6">Are you sure you want to unenroll this student?</h3>
                <div class="gap-4 flex justify-center">
                  <button data-modal-hide="unenroll-modal" data-modal-target="unenroll-success-modal" data-modal-toggle="unenroll-success-modal" type="button" class="text-white bg-red-400 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    Yes
                  </button>
                  <button data-modal-hide="unenroll-modal" type="button" class="text-deep-koamaru bg-transparent border border-purple-blue hover:bg-ghost-lavender focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">No</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="unenroll-success-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                <svg class="mx-auto mb-4 text-green-400 w-16 h-16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Student unenrolled successfully!</h3>
                <div class="flex justify-center">
                  <button data-modal-hide="unenroll-success-modal" type="button" class="text-white bg-neon-blue hover:bg-free-speech-blue focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
              </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-deep-koamaru">
              ...
              <tbody>
                <tr class="bg-white border-b border-indigo-100">
                  ...
                  <td class="flex items-center px-6 py-4">
                    <a href="./admin-edit-student.php" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    <button data-modal-target="enroll-modal" data-modal-toggle="enroll-modal" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Enroll</button>
                  </td>
                </tr>
                <tr class="bg-white border-b border-indigo-100">
                  <th scope="row" class="px-6 py-4 font-medium text-deep-koamaru whitespace-nowrap">
        ...
        <div id="enroll-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                <svg class="mx-auto mb-4 text-corn-flower-blue w-12 h-12" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center px-6">Are you sure you want to enroll this student?</h3>
                <div class="gap-4 flex justify-center">
                  <button data-modal-hide="enroll-modal" data-modal-target="enroll-success-modal" data-modal-toggle="enroll-success-modal" type="button" class="text-white bg-red-400 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    Yes
                  </button>
                  <button data-modal-hide="enroll-modal" type="button" class="text-deep-koamaru bg-transparent border border-purple-blue hover:bg-ghost-lavender focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">No</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="enroll-success-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                <svg class="mx-auto mb-4 text-green-400 w-16 h-16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Student Enrolled successfully!</h3>
                <div class="flex justify-center">
                  <button data-modal-hide="enroll-success-modal" type="button" class="text-white bg-neon-blue hover:bg-free-speech-blue focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
              </div>
