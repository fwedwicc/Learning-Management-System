...
<!--  Enrolled Course -->
<h1 class="font-bold text-5xl pb-6 text-corn-flower-blue mt-8 mb-2">Courses</h1>
<div class="grid grid-cols-3 gap-4" id='draggable-elements'>
  <!-- Course Card 1 -->
  <a href="./student-course-overview.php" class="relative block p-4 bg-white rounded-2xl hover:shadow-[15px_15px_30px_-3px_rgba(224,227,246)] transition duration-700 ease-in-out col-span-1 overflow-y-auto border-b-4 border-transparent hover:border-neon-blue" style="width: 350px; height: 380px;">
    <div class="relative">
    ...
    <h5 class="mt-5 text-2xl font-medium tracking-tight text-corn-flower-blue">Software Engineering</h5>
  ...
  <!-- Course Card 2 -->
  <a href="./student-course-overview.php" class="relative block p-4 bg-white rounded-2xl hover:shadow-[15px_15px_30px_-3px_rgba(224,227,246)] transition duration-700 ease-in-out col-span-1 overflow-y-auto border-b-4 border-transparent hover:border-neon-blue" style="width: 350px; height: 380px; left: 0;">
    <div class="relative">
      <img src="../../../assets/images/course-card-illustration.png" class="rounded-xl w-full" alt="Course Card Illustration" draggable="false">
      <h5 class="absolute top-2 left-2 text-4xl font-bold tracking-tight text-white">SE101</h5>
    </div>
    <div class="mt-5"> <!-- Adjust this margin to move content slightly to the right -->
      <h5 class="text-2xl font-medium tracking-tight text-corn-flower-blue">Software Engineering</h5>
      <span class="block text-deep-koamaru mt-2">Mary Anne Manandeg</span>
      <span class="block text-deep-koamaru">SBIT-2B</span>
      <!-- Semester Indicator -->
      <span class="mt-3 inline-flex items-center bg-ghost-lavender text-neon-blue text-sm font-medium px-4 py-2 rounded-full">
        2nd Semester
      </span>
    </div>
  </a>
...
<div class="grid grid-cols-3 gap-4 pt-10" id='draggable-elements'>
  <!-- Course Card 1 -->
  <a href="./student-course-overview.php" class="relative block p-4 bg-white rounded-2xl hover:shadow-[15px_15px_30px_-3px_rgba(224,227,246)] transition duration-700 ease-in-out col-span-1 overflow-y-auto border-b-4 border-transparent hover:border-neon-blue" style="width: 350px; height: 380px;">
    <div class="relative">
      <img src="../../../assets/images/course-card-illustration.png" class="rounded-xl w-full" alt="Course Card Illustration" draggable="false">
