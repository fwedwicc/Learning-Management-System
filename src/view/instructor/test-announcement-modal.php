...
<head>
  ...
  <title>Learning Management System | To-Do Card</title>
  <!-- Tailwind cdn -->
...
<body class="bg-ghost-white">
  ...
  <div class="block max-w-sm p-6 bg-white rounded-2xl drop-shadows row-span-1 overflow-y-auto">
    ...
    <h5 class="mb-4 text-2xl font-bold tracking-tight text-corn-flower-blue">Announcement</h5>
    <div class="max-w-md space-y-2.5 text-deep-koamaru list-inside">
      ...
      <button
            class="w-[16.5rem] text-white bg-neon-blue hover:bg-free-speech-blue focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-md text-sm px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105 document-next-button">
            Post Announcement
          </button>
      <!-- End Tiptap -->
