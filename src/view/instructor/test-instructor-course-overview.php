    ...
    <div class="pt-4 pl-4 rounded-2xl border-purple-blue mt-14">
      ...
      <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-purple-100 text-indigo-600">
        ...
        <h2 id="accordion-color-heading-1">
          <button type="button"
            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-deep-koamaru border border-b-0 border-purple-blue rounded-t-xl focus:ring-4 focus:ring-lavender-blue hover:bg-ghost-lavender transition duration-300 ease-in-out gap-3"
...
<script>
  ...
  lockBtn.addEventListener('click', () => {
    if (lockBtn.textContent.includes('Unlock')) {
      ...
      lockBtn.classList.add('bg-gray-400', 'text-white');
        ...
        <div id="accordion-color-body-1" class="overflow-hidden transition-all duration-300 ease-in-out"
            ...
            <div class="grid lg:grid-cols-3 sm:grid-cols-1 gap-4 mt-4">
              ...
              <div class="col-span-1">
                ...
                <ul class="list-none pt-4 text-deep-koamaru space-y-3">
                  <li>
                    <a href="#"
                      class="w-full px-3 py-2 text-sm font-medium text-center inline-flex items-center text-royal-blue border border-royal-blue hover:bg-hawkes-blue focus:ring-4 focus:outline-none focus:ring-tropical-blue rounded-lg text-sm bg-solitude transition ease-in-out duration-300">
                      <svg class="w-3 h-3 me-2 text-royal-blue" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <h2 id="accordion-color-heading-2">
          <button type="button"
            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-deep-koamaru border border-b-0 border-purple-blue focus:ring-4 focus:ring-lavender-blue hover:bg-ghost-lavender transition duration-300 ease-in-out gap-3"
                ...
                <ul class="list-none pt-4 text-gray-500 dark:text-gray-400 space-y-3">
                  <li>
                    <a href="./student-activity.php"
                      class="w-full px-3 py-2 text-sm font-medium text-center inline-flex items-center text-camarone border border-camarone hover:bg-granny-apple focus:ring-4 focus:outline-none focus:ring-chinook rounded-lg transition duration-300 ease-in-out bg-off-green">
                      <svg class="w-3 h-3 me-2 text-camarone" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <h2 id="accordion-color-heading-5">
          <button type="button"
            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-deep-koamaru border border-b-1 border-purple-blue focus:ring-4 focus:ring-lavender-blue hover:bg-ghost-lavender transition duration-300 ease-in-out gap-3"
  ...
  <aside id="logo-sidebar"
    class="fixed top-0 right-0 z-40 w-[21rem] h-screen pt-20 transition-transform -translate-x-full bg-ghost-white sm:translate-x-0 hidden sm:block"
    aria-label="Sidebar">
    <div class="h-full pt-2 pb-7 gap-5 pl-1 pr-8 overflow-y-auto bg-ghost-white grid grid-rows-2">
      <!-- Announcement card -->
      <div
        class="block max-w-sm p-8 bg-white rounded-2xl drop-shadows row-span-1 overflow-y-auto space-y-4 flex flex-col justify-between">
        <div>
